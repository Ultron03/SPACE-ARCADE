...
bg_y_shift = -HEIGHT
background_img = pygame.image.load('images/space.png').convert()
background_img2 = pygame.transform.scale(pygame.image.load('images/space2.jpeg').convert(),(WIDTH,HEIGHT))
# pygame.transform.scale(pygame.image.load('spaceship_red.png'), (64, 64))
background_img3 = pygame.transform.scale(pygame.image.load('images/space3.jpeg').convert(),(WIDTH,HEIGHT))
background_img4 =pygame.transform.scale(pygame.image.load('images/space4.jpeg').convert(),(WIDTH,HEIGHT))
...
enemy1_img = [
    ...
    pygame.transform.scale(pygame.image.load('images/enemy/enemy1_2.png').convert_alpha(),(64,64)),
